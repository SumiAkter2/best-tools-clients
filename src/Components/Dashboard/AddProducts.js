...
const AddProducts = () => {
  ...
  return (
    <div>
      <h1 className="text-pink-500 text-left font-bold py-4">
        ADD A NEW PRODUCT:
      </h1>
      <form className="w-full grid lg:grid-cols-3 gap-4">
        <input
          ...
          className="input pt-3 w-full input-bordered input-secondary max-w-xs"
        />
        <input
        ...
        <div className="form-control w-full max-w-xs">
          ...
          <select className="select select-secondary">
            ...
            <option>https://i.ibb.co/jT6Zd2d/imgg5.jpg</option>
        ...
        <button onClick={handlePost} className="btn btn-primary my-4">
          Add Now
        </button>
      </form>
    </div>
