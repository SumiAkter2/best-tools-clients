      ...
      <div className="hero min-h-screen bg-base-200 px-12">
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div className="text-left">
            ...
            <p className="py-4">
              We provide best tools for our clients that they can benefited. the
              demand of users all over to have more access to content. Between
              driller, nuts, bolt, and accessibility on the tools is so easy to
              use.
            </p>
